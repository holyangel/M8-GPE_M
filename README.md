M8-GPE_M
SkyDragon GPE Kernel for HTC M8 on Marshmallow

defconfig file: sd_defconfig (arm-eabi-4.9.4)

Toolchain Download:
Linaro GCC 4.9.4 Arm Cortex-A15
http://forum.xda-developers.com/showthread.php?p=36677987

Build the kernel:
set the following environment variables:

Open Makefile, find CROSS_COMPILE := xxxx
and make sure "xxxx" is set to the path to your toolchain directory
save and exit
...
And you are done! Use AnyKernel or repackage your boot.img yourself and flash ^^
